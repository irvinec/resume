...
{\begin{itemize}
  \item Worked on Cognitive Services Personalizer building a compliant and scalable real-time reinforcement learning service using ASP.NET, Python, and Spark.
  \item Automated cross-platform and cross-architecture build using Python, CMake, Vcpkg, Docker and Azure DevOps.
  \item Developed open source client and other components for IoT device software updates in C, C++ and CMake.
  \item Worked on MSN News App building engaging desktop and iOS and Android mobile applications using JavaScript, C\#, Objective-C, and Java.
  \item C++, COM and WinRT development of core operating system and browser components.
  \item Worked on Windows Phone NFC payments and Received Windows Phone Excellence in Execution Award.
\end{itemize}
}
...
{\begin{itemize}
  \item Mentored Bellevue College students for undergraduate research project for text annotation of images.
  \item Mentored Bellevue College students for summer game design program.
  \item Mentored Bellevue College students for undergraduate research in reinforcement learning. Helped Students build DQN and Gym environment to control Sphero robot in a physical environment.
  \item Bellevue College STEM Advisory Board member.
  \item Bellevue College 2019 Global Game Jam judge.
\end{itemize}
}
